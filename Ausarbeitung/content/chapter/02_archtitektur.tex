...
Der Networking \& Transporting Layer enthält mehrere verschiedene Netzwerk- und Transportprotokolle und entspricht den \ac{OSI} Layern 3 und 4. Die Aufgabe ist das Routing und der Ende zu Ende Transport von Daten. Er wird im Kapitel \autoref{chap:networklayer} genauer beschrieben. 


\subsection{Facilities \label{architektur_facilitiesLayer}}
Der Facilities Layer entspricht den \ac{OSI} Layern 5, 6 und 7. Er bietet eine Sammlung von Funktionen, die die \ac{ITS} Anwendungen unterstützen. Der Layer bietet Datenstrukturen um verschiedene Daten zu speichern, zu sammeln und zu verwalten. Er wird im Kapitel \autoref{chap:facilitylayer} genauer erklärt.
...
Eine weitere Beschreibung des Application Layers und eine Auswahl seiner Use Cases findet im Kapitel \autoref{sec:applicationLayer} statt.
