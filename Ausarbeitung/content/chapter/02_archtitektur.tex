...
\todo{Wenn noch Zeit, ein bisschen was über den Vergleich schreiben}  
...
In \ac{ITS-G5} wird das Verfahren \ac{EDCA} verwendet. Es baut auf einem CSMA/CA Algorithmus auf, erweitert die klassischen Algorithmen aber um \ac{QOS} Elemente. 
...
Die Autorisierungsstelle regelt den Zugang zu allgemeinen und speziellen Diensten. Um die Dienste der Autorisierungsstelle nutzen zu können muss die die Identität der \ac{ITS-S} durch ein Zertifikat einer Zulassungsstelle nachgewiesen werden. Die \ac{ITS-S} fragt bei der Autorisierungsstelle wegen der spezifischen Berechtigungen an. Die Anfragen werden \todo{An Authorization Authority weiterschreiben} 
