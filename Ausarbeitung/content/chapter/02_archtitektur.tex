...
\begin{figure}[h]
	\includegraphics[width=0.75\textwidth]{content/images/02_architektur/enrolementFlowDiagramm.pdf}
...
Die Authenticate Station löst nach dem Empfang des Authentication Request (Request) eine Enrolment Challenge(Request) aus. Diese \\\\\\\\\\\\\\
